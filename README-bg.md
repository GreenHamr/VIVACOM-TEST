...
**Лична бележка.** За REST API бих избрал език, по-близък до избрания уеб сървър (напр. PHP с Apache). Реализацията на API-то на C++ увеличава сложността и затруднява поддржката.
