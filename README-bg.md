...
==================================================================================
моето лично мнение : За REST API бих използвал някой друг език за програмиране , който е по-близък до избрания WEB сървър. Например за Apache е добре да се използва PHP . Използването на C++ за реализация на REST API увеличава сложността на задачата и затруднява поддржката. 